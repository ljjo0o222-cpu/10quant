export const translations = {
  ko: {
    ...
    actualReturns: {
      ...
      viewAll: '전체보기',
      viewLess: '줄여서보기',
      weeklyNotice: '주간 수익률은 커뮤니티에서 확인이 가능합니다.',
    },
    footer: {
      desc: 'RealQuant는 데이터 기반의 정량적 투자 솔루션을 제공하는 퀀트 솔루션입니다.',
      disclaimer: '자동화 거래 시스템 및 솔루션은 수익을 보장하는 상품이 아닙니다. 시장의 특성상 주기성이 존재하므로 수익이 발생하는 주기와 손실이 발생하는 주기가 공존합니다.\n확률과 통계학에 기반하여 점차 시드가 우상향 하는 것을 목표로 하고 있으며, 해당 웹사이트에 표현되어 있는 백테스트와 실제 수익률은 과거 성과에 해당합니다.\n과거 성과는 향후 성과를 예측할 수 있을 뿐, 절대적으로 고객의 원금을 보장하지 아니하고 수익을 보장하지 않는다는 점을 명확히 인지해 주시기 바랍니다.',
  ...
  en: {
    ...
    partners: {
      ...
      desc: 'Trusted by leading financial institutions and technology partners worldwide.',
      viewMore: 'VIEW MORE +',
    },
    features: {
    ...
    actualReturns: {
      ...
      viewAll: 'View All',
      viewLess: 'View Less',
      weeklyNotice: 'Weekly returns can be checked in the community.',
    },
    footer: {
      desc: 'RealQuant is a quantitative investment firm providing data-driven quantitative investment solutions.',
      disclaimer: 'Automated trading systems and solutions are not products that guarantee profits. Due to the nature of the market, periodicity exists, so periods of profit and periods of loss coexist. Based on probability and statistics, we aim for the seed to gradually trend upward, and the backtests and actual returns expressed on this website correspond to past performance. Please clearly understand that past performance can only predict future performance and does not absolutely guarantee the customer\'s principal or profits.',
      rights: '© 2026 RealQuant. All rights reserved.',
    },
    admin: {
  ...
  zh: {
    ...
    actualReturns: { title: '实际收益', viewAll: '全部查看', viewLess: '收起', weeklyNotice: '周收益率可以在社区中查看。' },
  ...
  ja: {
    ...
    actualReturns: { title: '実際の収益', viewAll: '全て表示', viewLess: '閉じる', weeklyNotice: '週次収益はコミュニティで確認できます。' },
  ...
  de: {
    ...
    actualReturns: { title: 'Tatsächliche Renditen', viewAll: 'Alle anzeigen', viewLess: 'Weniger anzeigen', weeklyNotice: 'Wöchentliche Renditen können in der Community überprüft werden.' },
