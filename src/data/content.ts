...
export const translations = {
  ...
  en: {
    nav: { home: 'Home', partners: 'Partners', strategies: 'RealQuant Strategy', quantStrategies: 'RealQuant Strategy', performance: 'Backtest', actualReturns: 'Actual Returns', faq: 'FAQ', calculator: 'Compound Calculator', admin: 'Admin' },
  ...
  zh: {
    nav: { home: '首页', partners: '合作伙伴', strategies: 'RealQuant 策略', quantStrategies: 'RealQuant 策略', performance: '回测', actualReturns: '实际收益', faq: '常见问题', calculator: '复利计算器', admin: '管理员' },
  ...
  ja: {
    nav: { home: 'ホーム', partners: 'パートナー', strategies: 'RealQuant 戦略', quantStrategies: 'RealQuant 戦略', performance: 'バックテスト', actualReturns: '実際の収益', faq: 'よくある質問', calculator: '複利計算機', admin: '管理者' },
  ...
  ru: {
    nav: { home: 'Главная', partners: 'Партнеры', strategies: 'Стратегии RealQuant', quantStrategies: 'Стратегии RealQuant', performance: 'Бэктестинг', actualReturns: 'Реальная доходность', faq: 'FAQ', calculator: 'Калькулятор сложного процента', admin: 'Админ' },
  ...
  de: {
    nav: { home: 'Startseite', partners: 'Partner', strategies: 'RealQuant-Strategien', quantStrategies: 'RealQuant-Strategien', performance: 'Backtesting', actualReturns: 'Tatsächliche Renditen', faq: 'FAQ', calculator: 'Zinseszinsrechner', admin: 'Admin' },
  ...
  fr: {
    nav: { home: 'Accueil', partners: 'Partenaires', strategies: 'Stratégies RealQuant', quantStrategies: 'Stratégies RealQuant', performance: 'Backtesting', actualReturns: 'Rendements réels', faq: 'FAQ', calculator: 'Calculateur d\'intérêts composés', admin: 'Admin' },
  ...
  hi: {
    nav: { home: 'होम', partners: 'साझेदार', strategies: 'RealQuant रणनीतियाँ', quantStrategies: 'RealQuant रणनीतियाँ', performance: 'बैकटेस्टिंग', actualReturns: 'वास्तविक रिटर्न', faq: 'FAQ', calculator: 'चक्रवृद्धि कैलकुलेटर', admin: 'व्यवस्थापक' },
  ...
  es: {
    nav: { home: 'Inicio', partners: 'Socios', strategies: 'Estrategias RealQuant', quantStrategies: 'Estrategias RealQuant', performance: 'Backtesting', actualReturns: 'Rentabilidades reales', faq: 'Preguntas', calculator: 'Calculadora de interés compuesto', admin: 'Admin' },
  ...
  ar: {
    nav: { home: 'الرئيسية', partners: 'الشركاء', strategies: 'استراتيجيات RealQuant', quantStrategies: 'استراتيجيات RealQuant', performance: 'الاختبار العكسي', actualReturns: 'العوائد الحقيقية', faq: 'الأسئلة الشائعة', calculator: 'حاسبة الفائدة المركبة', admin: 'المسؤول' },
